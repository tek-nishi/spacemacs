...
`dotspacemacs/user-config' first."
  (load-library "ls-lisp")				; diredの挙動をWindowsと揃える
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(dired-directory ((t (:inherit nil :background "#292b2e" :foreground "#4f97d7"))))
 '(org-agenda-date ((t (:foreground "#7590db" :height 1.0))))
 '(org-agenda-date-today ((t (:inherit bold :foreground "#4f97d7" :height 1.0))))
 '(org-agenda-date-weekend ((t (:inherit nil :foreground "#7590db"))))
 '(org-agenda-done ((t (:foreground "forest green" :height 1.0))))
 '(org-done ((t (:inherit bold :background "#293235" :foreground "lime green"))))
 '(org-level-1 ((t (:inherit nil :foreground "#4f97d7" :height 1.0))))
 '(org-level-2 ((t (:inherit nil :foreground "#2d9574" :height 1.0))))
 '(org-level-3 ((t (:foreground "#67b11d" :weight normal :height 1.0))))
 '(org-todo ((t (:inherit bold :foreground "#c00000")))))
